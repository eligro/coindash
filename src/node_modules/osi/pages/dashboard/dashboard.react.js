...
import Positions from '../../../../components/pages/dashboard/Positions.react'
import AddTokenForm from '../../../../components/pages/dashboard/AddTokenForm.react'
        ...
        {(hasAccounts && hasTokens &&
          ...
          <div className='top-cont'>
            <Card>
              ...
              <p>Please add your <Link to='/accounts'>accounts</Link> to the system to proceed.</p>
            </Card>
          </div>
        }
        <ScrollArea className='tokens-a bottom-cont' style={{flex: '1 1 auto'}}>
