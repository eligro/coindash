...
const steps = [
  {
    ...
    content: <div>
      <h2>Account Balance and Tokens</h2>
      <p>you can now explore deep and meaningful insights into the various investments that portfolio did, how well it performed against the market and much more. Let's explore some of those insights</p>
    </div>
  },
  {
