      ...
      >
        <Paper zDepth={3} style={{ borderRadius: '5px' }}>
          <Card
            ...
            headerActions={<Link to='/'><FontAwesome name='times' /></Link>}
          >
            <div className='up'>
              ...
              <div className='done'>
                ...
                <p>
                  Your email as it is registered in our system is
                  {' '}
                  <code>{email}</code>
                  .
                </p>
              ...
              <br />
              <Button onClick={e => this.handleLogout(e)} bsStyle='primary' block>Logout</Button>
