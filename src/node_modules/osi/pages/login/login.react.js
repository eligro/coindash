...
class LoginPage extends Component {
    ...
    return (
      <Page className='login'>
        ...
        <Card className='login' title='&nbsp;' headerActions={<Link to='/'><FontAwesome name='times' /></Link>}>
          ...
          {this.signinButton('facebook', 'Facebook')}
  ...
  signinButton (name, title) {
    return <Button className={`signin-with ${name}`} onClick={() => this.signinWith(name)} block><FontAwesome name={name} /> Sign in with {title}</Button>
  }
  signinWith (provider) {
