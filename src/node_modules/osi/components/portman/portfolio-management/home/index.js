      ...
      <Dialog
        ...
        actions={([
          <FlatButton
            label='Cancel'
            primary
            onTouchTap={e => this.props.onCancel(e)}
          />,
          <FlatButton
            label='Submit'
            primary
...
class Home extends Component {
  ...
  onCellClicked (row, cell, event) {
    const { portfolio } = this.props
    const { userPortfolios = [] } = portfolio

    // console.log('row/cell clicked:', row, cell)
    console.log('row, cell, event', row, cell, event)
    // console.log('more', more)
    this.props.portfolioActions.setCurrentPortfolio(userPortfolios[row])
  }
  render () {
    const { userPortfolios } = this.props
