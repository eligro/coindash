...
class Wrap extends Component {
  ...
  shouldComponentUpdate (nextProps, nextState) {
    ...
    const {
      ...
      userPortfoliosFetching: nextUserPortfoliosFetching,
      currentPortfolio: nextCurrentPortfolio,
      currentBalances: nextCurrentBalances
    } = nextProps

    const ignoreProps = ['currentBalances', 'currentPortfolio', 'location', 'params', 'user', 'hasUser', 'routeParams', 'route', 'router', 'routes', 'children', 'portfoliosLoaded', 'userPortfoliosFetching']
