...
const MSGs = ({en, kr, ch, ...props}) => <PresaleCard className='insert'
    ...
    promo={<div className='claims'>
        <p>
          <a href='https://docs.google.com/forms/u/0/d/e/1FAIpQLSfhsgw__FlDwv3J0BQsZCW_4IH6OSJQz_VPXX0wa98WffajOw/viewform?usp=sf_link'>Claims Forms</a> -
          Login to the application: <Link to='/login'>Coindash App</Link>
        </p>
    </div>}
  />
