...
class Portfolio extends Component {
  ...
  componentDidMount () {
    ...
    console.log('component portfolio mounted', portfolio)
    if (portfolio && portfolio.portfolio && portfolio.portfolio.lastCalculated) {
      console.log('it has lastCalculated!', portfolio.portfolio.lastCalculated)
      let shouldIupdate = (!process || !process.fetching) && // not fetching, and
        (!calculations || !calculations.portfolio || !calculations.market) // doesn't have calculations

      shouldIupdate && console.log('Fetching calculations...')
    ...
    return (
      <div className={['portfolio', pid].join(' ')}>
        ...
        {this.props.calculations && (
          <pre>{JSON.stringify(Object.keys(this.props.calculations), 1, 1)}</pre>
        )}
