...
class Portfolio extends Component {
  ...
  render () {
    ...
    if (!this.state.ready) return <Spinner>Loading portfolio...</Spinner>
    return (
          ...
          {balances && balances.data && balances.data.length && (
            <div className='tokes'>
              ...
              <DataTable plain>
                <TableHeader>
                  <TableRow>
                    <TableColumn colSpan='2'>Symbol</TableColumn>
                    <TableColumn />
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {balances.data.map(({title, amount, value}, index) => {
                    return (
                      <TableRow key={index}>
                        <TableColumn>{title === 'ETH' && <EthereumIcon size={28} />}</TableColumn>
                        <TableColumn>{title}</TableColumn>
                        <TableColumn>{amount} (${value})</TableColumn>
                      </TableRow>
                    )
                  })}
                </TableBody>
