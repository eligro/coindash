...
const Spinner = (props) => (
  <div className='spinner'>
    <CircularProgress size={80} thickness={5} color='rgba(255, 255, 255, 0.7)' />
    <h3>{props.message || 'Loading...'}</h3>
  </div>
)

function FieldGroup ({ id, label, help, error, className, ...props }) {
  return (
          ...
          <div className='up'>
            <form>
              <FieldGroup className={!!this.state.inputs.email && 'has-value'}
                ...
                label='Email'
                placeholder='Email'
                error={this.state.userError && this.state.userError.code.match(/email/) && this.state.userError.message}
