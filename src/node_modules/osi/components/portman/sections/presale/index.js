...
class PresalePage extends Component {
  ...
  attemptCoupon (e) {
    ...
    console.log('do coupon!', this.couponValue)
    Coupons.isCouponValid(this.couponValue)
      .then(res => {
  ...
  render () {
    ...
    return (
      <div className='presale'>
        <h3>Welcome to Presale!</h3>
        <p>Do you have a coupon for Coindash Presale? Use it here!</p>

        <form className='coupons' onSubmit={e => this.attemptCoupon(e)}>
          <legend>Enter Coupon Here</legend>
          <TextField id='coupon-input' floatingLabelText='Enter Coupon' onChange={(e, v) => this.couponValue = v} />
