...
class Dashboard extends Component {
  ...
  componentDidMount () {
    ...
    if (portfolio && portfolio.portfolio && portfolio.portfolio.lastCalculated) {
      ...
      shouldIupdate
        ? portfolioActions.loadPortfolioCalculations(portfolio)
          .then(result => {
  ...
  render () {
    const { user, userPortfolios, calculations, balances } = this.props
    ...
    return (
      <div className='dashboard md-text'>
        ...
        <div className='stats'>
          ...
          <Benchmark calculations={calculations} balances={balances} />
        </div>
