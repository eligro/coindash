...
const frontKeys = frontCoins.map(e => e.short)

class Tickers extends Component {
  render () {
    const { coins } = this.props
    const items = coins && coins.length && coins.filter(c => frontKeys.indexOf(c.short) >= 0)
    return (
