...
class Wrap extends Component {
  ...
  shouldComponentUpdate (nextProps, nextState) {
    ...
    if (nextProps.portfolio.activePortfolio !== this.props.portfolio.activePortfolio) return true
...
function mapStateToProps (state, ownProps) {
  ...
  const nextProps = {
    ...
    currentPortfolio: (portfolio && portfolio.hasUserPortfolios && (portfolio.activePortfolio || portfolio.userPortfolios[0]))
  }
