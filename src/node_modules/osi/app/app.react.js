...
import Sidenav from '../components/sidenav/sidenav.react'
import Header from 'osi/components/header2'

import VersionNotificationDialog from './version-notification'
...
class App extends Component {
  ...
  componentWillUpdate (nextProps, nextState) {
    ...
    // Check tour state
    if (!nextProps.userProps || !nextProps.userProps.tour) {
      // Start the tour
        ...
        User.getUser(cu.uid)
          .then(userVal => {
            if (userVal === null) {
              ...
              if (userVal.properties && Object.keys(userVal.properties).length) {
                this.props.userActions.updateUserProperties(userVal.properties)
              } else if (!this.props.user.propertiesLastUpdate) {
                this.props.userActions.updateUserProperties({})
              }
            }
          })
...
function mapStateToProps (state, ownProps) {
  ...
  return {
    ...
    userProps: user && user.profile && user.profile.properties
  }
}
