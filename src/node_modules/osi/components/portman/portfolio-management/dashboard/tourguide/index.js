...
class TourGuide extends Component {
  ...
  componentWillMount () {
    console.info('tourguide will mount')
    this.checkIfReady(this.props, this.state)
  }
  componentWillUpdate (nextProps, nextState) {
    console.log('tourguide will update')
  ...
  checkIfReady (nextProps, nextState) {
    ...
    console.log('tourguide will update')
    console.log('lastTourVersion', lastTourVersion)
    console.log('lastCalculated', lastCalculated)
