  ...
  render () {
    return (
      <div className='stock-charts'>
        {!this.props.chartData && this.props.exchanges.length && (
          <div className='spinner-container'>
            <Spinner value={this.props.loadingProgress} className='determinate'>Calculation in progress...</Spinner>
            <Spinner className='indeterminate'>Calculation in progress...</Spinner>
          </div>
        )}
