    ...
    return (
      <Card className='charts' title={title} headerActions={actions}>
        {this.state.selectedChart === 1 &&
          ...
          <StocksChart chartData={this.props.chartData} dayDataByDate={this.props.portfolioDayDataByDate} exchanges={this.props.exchanges} loadingProgress={this.props.statusText} />}
