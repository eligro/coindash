...
class Portfolio extends Component {
  ...
  startPortfolio ({disablePortfolio = false, disableBalances = false} = {}) {
    const { portfolio, chartActions, balancesActions, addressList = [], tokens, user } = this.props
    ...
    if (!addressList.length) {
      ...
      if (user && user.properties) { // Identify user who had not dismissed a tour before
        if (user.properties.takenTour == null) { userActions.activateTour(this.props.user.profile.uid) }
      }
