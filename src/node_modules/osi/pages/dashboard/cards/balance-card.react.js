          ...
          {props.balances.sort((a, b) => a.value < b.value)
            .map((b, i) => (
              <li className={`token token-${b.title}`} key={b.title}>
                <Circle percent={b.value / total * 100} strokeWidth='18' strokeColor={colors[props.balances.length][i]} trailWidth='18' strokeLinecap='square' trailColor='rgba(255,255,255,0.2)' />
