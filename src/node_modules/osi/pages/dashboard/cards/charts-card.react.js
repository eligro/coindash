  ...
  render () {
    ...
    return (
      <Card className='charts' title={title} headerActions={actions}>
        ...
        <card-footer>
          <Valuable className='most' onClick={() => this.setSelectedChart(1)}>Performance</Valuable>
          <Valuable className='least' onClick={() => this.setSelectedChart(3)}>Allocation</Valuable>
        </card-footer>
      </Card>
    )
  }
