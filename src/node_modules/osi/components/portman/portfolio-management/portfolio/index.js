...
class Portfolio extends Component {
  ...
  startPortfolio ({disablePortfolio = false, disableBalances = false}) {
    ...
    if (!addressList.length) {
      ...
      !disableBalances && balancesActions.calcBalances(portfolio.portfolio.pid, addressList)
        .then(result => this.associateIdentifiedTokens(result))
      !disablePortfolio && chartActions.calcPortfolio(portfolio.portfolio.pid, addressList)
    }
  }
